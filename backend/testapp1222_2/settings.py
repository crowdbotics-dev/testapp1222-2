"""
Django settings for testapp1222_2 project.
...
ROOT_URLCONF = 'testapp1222_2.urls'
...
WSGI_APPLICATION = 'testapp1222_2.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestApp1222 Support <support@testapp1222-2.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp1222_2 API",
    "DESCRIPTION": "API documentation for testapp1222_2 App",
    "VERSION": "v1",
}
